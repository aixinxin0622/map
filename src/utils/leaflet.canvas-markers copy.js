...
!(function (t) {
  ...
  function (t, n, i) {
    ...
    function p(t, n, i, a, o) {
      for (var r, s = [n, i]; s.length; )
        (i = s.pop()) - (n = s.pop()) <= a || ((r = n + Math.ceil((i - n) / a / 2) * a), e(t, r, n, i, o), s.push(n, r, r, i));
    }
    ...
    a.prototype = {
      ...
      search: function (t) {
        ...
        if (!f(t, n)) return i;
        for (var a, o, r, s, h = []; n; ) {
          for (a = 0, o = n.children.length; a < o; a++)
            (r = n.children[a]), f(t, (s = n.leaf ? e(r) : r)) && (n.leaf ? i.push(r) : _(t, s) ? this._all(r, i) : h.push(r));
          n = h.pop();
        }
        return i;
      },
      ...
      remove: function (t, n) {
        ...
        for (var i, e, a, r, s = this.data, h = this.toBBox(t), c = [], l = []; s || c.length; ) {
          if ((s || ((s = c.pop()), (e = c[c.length - 1]), (i = l.pop()), (r = !0)), s.leaf && -1 !== (a = o(t, s.children, n))))
            return s.children.splice(a, 1), c.push(s), this._condense(c), this;
          r || s.leaf || !_(s, h)
            ? e
              ? (i++, (s = e.children[i]), (r = !1))
              : (s = null)
            : (c.push(s), l.push(i), (i = 0), (e = s), (s = s.children[0]));
        }
        return this;
      },
      toBBox: function (t) {
      ...
      _build: function (t, n, i, e) {
        ...
        var h,
          ...
          m,
          u = Math.ceil(o / s),
          _ = u * Math.ceil(Math.sqrt(s));
        for (p(t, n, i, _, this.compareMinX), h = n; h <= i; h += _)
          for (p(t, h, (l = Math.min(h + _ - 1, i)), u, this.compareMinY), c = h; c <= l; c += u)
            (m = Math.min(c + u - 1, l)), a.children.push(this._build(t, c, m, e - 1));
        return r(a, this.toBBox), a;
      },
      _chooseSubtree: function (t, n, i, e) {
        for (var a, o, r, s, h, c, l, u, _, f; e.push(n), !n.leaf && e.length - 1 !== i; ) {
          for (l = u = 1 / 0, a = 0, o = n.children.length; a < o; a++)
            (h = m((r = n.children[a]))),
              (_ = t),
              (f = r),
              (c = (Math.max(f.maxX, _.maxX) - Math.min(f.minX, _.minX)) * (Math.max(f.maxY, _.maxY) - Math.min(f.minY, _.minY)) - h) < u
                ? ((u = c), (l = h < l ? h : l), (s = r))
                : c === u && h < l && ((l = h), (s = r));
          n = s || n.children[0];
        }
      ...
      _insert: function (t, n, i) {
        var e = this.toBBox,
          a = i ? t : e(t),
          o = [],
          r = this._chooseSubtree(a, this.data, n, o);
      ...
      _split: function (t, n) {
        ...
        var o = this._chooseSplitIndex(i, a, e),
          s = d(i.children.splice(o, i.children.length - o));
      ...
      _chooseSplitIndex: function (t, n, i) {
        ...
        for (c = l = 1 / 0, e = n; e <= i - n; e++)
          (a = s(t, 0, e, this.toBBox)),
            (o = s(t, e, i, this.toBBox)),
            (_ = a),
            (f = o),
            void 0,
            void 0,
            void 0,
            void 0,
            (d = Math.max(_.minX, f.minX)),
            (p = Math.max(_.minY, f.minY)),
            (x = Math.min(_.maxX, f.maxX)),
            (g = Math.min(_.maxY, f.maxY)),
            (r = Math.max(0, x - d) * Math.max(0, g - p)),
            (h = m(a) + m(o)),
            r < c ? ((c = r), (u = e), (l = h < l ? h : l)) : r === c && h < l && ((l = h), (u = e));
        return u;
      },
      _chooseSplitAxis: function (t, n, i) {
        var e = t.leaf ? this.compareMinX : c,
      ...
      _condense: function (t) {
        for (var n, i = t.length - 1; i >= 0; i--)
          0 === t[i].children.length ? (i > 0 ? (n = t[i - 1].children).splice(n.indexOf(t[i]), 1) : this.clear()) : r(t[i], this.toBBox);
      },
          ...
          for (; o > a; ) {
            if (o - a > 600) {
              var s = o - a + 1,
                ...
                m = 0.5 * Math.sqrt((c * l * (s - l)) / s) * (h - s / 2 < 0 ? -1 : 1),
                u = Math.max(a, Math.floor(e - (h * l) / s + m)),
                _ = Math.min(o, Math.floor(e + ((s - h) * l) / s + m));
              n(i, e, u, _, r);
            }
            var f = i[e],
              d = a,
        ...
        _drawImage: function (marker, pointPos) {
          ...
          e
            ? (this._context.save(),
              ...
              this._context.rotate((e * Math.PI) / 180),
              this._context.drawImage(marker.canvas_img, -options.iconAnchor[0], -options.iconAnchor[1], options.iconSize[0], options.iconSize[1]),
        ...
        _drawText: function (marker, pointPos) {
          ...
          if (options.text) {
            (this._context.font = options.textFont),
              ...
              this._context.fillText(options.text, pointPos.x - options.textAnchor[0], pointPos.y - options.textAnchor[1]);
          }
        },
